            ...
            <div id="loginbox" class="mainbox col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3"> 
                ...
                <div class="panel panel-default" >
                    ...
                    <div class="panel-body" >
                        ...
                        <form name="form" id="form" class="form-horizontal" method="POST" action="login.jsp?op=login">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12 controls">
                                    ...
                                    <a href="forgotpassword.jsp" class="btn btn-primary pull-left"><i class="glyphicon glyphicon-log-in"></i> Forgot Password?</a>                                     
