            ...
            <div id="loginbox" class="mainbox col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3"> 
                ...
                <div class="panel panel-default" >
                    ...
                    <div class="panel-body" >
                        ...
                        <form name="form" id="form" class="form-horizontal" method="POST" action="forgotpassword.jsp?op=resetpassword">

                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                <input id="password" type="password" class="form-control" name="password" value="" placeholder="New Password" required="required">                                        
                            </div>

                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                                <input id="cnfpassword" type="password" class="form-control" name="cnfpassword" placeholder="Confirm Password" required="required">
                            </div>                                                                  
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12 controls">
                                    <button type="submit" name="resetpassword" id="resetpassword" class="btn btn-primary pull-right"><i class="glyphicon glyphicon-log-in"></i> Reset Password</button>   
                                </div>
                            </div>
